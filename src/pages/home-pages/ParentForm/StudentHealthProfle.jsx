...
const StudentHealthProfile = () => {
  ...
  return (
    ...
    >
      <p>
        <b>Họ tên:</b> {profile?.studentFullName}
      </p>
      <p>
        <b>Thị lực:</b> {profile?.visionTest}
      </p>
      <p>
        <b>Chiều cao:</b> {profile?.height} cm
      </p>
      <p>
        <b>Cân nặng:</b> {profile?.weight} kg
      </p>
      <p>
        <b>Bệnh mãn tính:</b> {profile?.chronicDisease}
      </p>
      <p>
        <b>Dị ứng:</b> {profile?.allergy}
      </p>
      <p>
        <b>Ngày khám gần nhất:</b> {formatDate(profile?.lastCheckupDate)}
      </p>
    </Card>
  );
};
